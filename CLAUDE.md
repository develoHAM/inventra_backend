...
**Current state:** Phases 0–10a complete, plus the file-upload + order/audit CSV·xlsx import/export track. **In progress: notifications + account security (Slice 1a done, 1b next)** — see STATUS.md.
...
## Commands
- `npm test` — unit suite (currently **233 green**).
